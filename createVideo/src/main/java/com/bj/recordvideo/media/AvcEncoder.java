...
public class AvcEncoder {
    ...
    private void init(int width, int height) {
        ...
        MediaFormat mediaFormat = MediaFormat.createVideoFormat(MediaFormat.MIMETYPE_VIDEO_HEVC, width, height);//COLOR_FormatYUV420SemiPlanar
